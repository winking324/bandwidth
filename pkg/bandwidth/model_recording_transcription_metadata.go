...
// checks if the RecordingTranscriptionMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RecordingTranscriptionMetadata{}
