...
// checks if the ConferenceMemberJoinCallback type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ConferenceMemberJoinCallback{}
...
type ConferenceMemberJoinCallback struct {
...
func NewConferenceMemberJoinCallback() *ConferenceMemberJoinCallback {
	this := ConferenceMemberJoinCallback{}
	return &this
}
...
func (o *ConferenceMemberJoinCallback) SetTagNil() {
	o.Tag.Set(nil)
}
...
func (o ConferenceMemberJoinCallback) MarshalJSON() ([]byte, error) {
...
func (o ConferenceMemberJoinCallback) ToMap() (map[string]interface{}, error) {
...
type NullableConferenceMemberJoinCallback struct {
	value *ConferenceMemberJoinCallback
	isSet bool
}

func (v NullableConferenceMemberJoinCallback) Get() *ConferenceMemberJoinCallback {
	return v.value
}

func (v *NullableConferenceMemberJoinCallback) Set(val *ConferenceMemberJoinCallback) {
	v.value = val
	v.isSet = true
}

func (v NullableConferenceMemberJoinCallback) IsSet() bool {
	return v.isSet
}

func (v *NullableConferenceMemberJoinCallback) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableConferenceMemberJoinCallback(val *ConferenceMemberJoinCallback) *NullableConferenceMemberJoinCallback {
	return &NullableConferenceMemberJoinCallback{value: val, isSet: true}
}

func (v NullableConferenceMemberJoinCallback) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableConferenceMemberJoinCallback) UnmarshalJSON(src []byte) error {
	v.isSet = true
