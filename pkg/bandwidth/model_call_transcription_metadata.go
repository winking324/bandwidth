...
// checks if the CallTranscriptionMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CallTranscriptionMetadata{}
...
func (o *CallTranscriptionMetadata) GetTranscriptionId() string {
	if o == nil || IsNil(o.TranscriptionId) {
		var ret string
		return ret
	}
...
func (o *CallTranscriptionMetadata) GetTranscriptionName() string {
	if o == nil || IsNil(o.TranscriptionName) {
		var ret string
		return ret
	}
...
func (o *CallTranscriptionMetadata) GetTranscriptionUrl() string {
	if o == nil || IsNil(o.TranscriptionUrl) {
		var ret string
		return ret
	}
