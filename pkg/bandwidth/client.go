...
// APIClient manages communication with the Bandwidth API v1.0.0
...
type APIClient struct {
	...
	ConferencesAPI *ConferencesAPIService
	...
	PhoneNumberLookupAPI *PhoneNumberLookupAPIService

	RecordingsAPI *RecordingsAPIService

	StatisticsAPI *StatisticsAPIService

	TranscriptionsAPI *TranscriptionsAPIService
}
