...
// checks if the BridgeTargetCompleteCallback type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BridgeTargetCompleteCallback{}
