...
// checks if the ListMessageItem type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ListMessageItem{}
...
type ListMessageItem struct {
	...
	CampaignClass NullableString `json:"campaignClass,omitempty"`
...
func (o *ListMessageItem) GetDestinationTn() string {
	if o == nil || IsNil(o.DestinationTn) {
		var ret string
		return ret
	}
...
func (o *ListMessageItem) GetMessageDirection() ListMessageDirectionEnum {
	if o == nil || IsNil(o.MessageDirection) {
...
func (o *ListMessageItem) GetMessageSize() int32 {
	if o == nil || IsNil(o.MessageSize.Get()) {
		var ret int32
		return ret
	}
...
func (o *ListMessageItem) GetMessageLength() int32 {
	if o == nil || IsNil(o.MessageLength) {
		var ret int32
		return ret
	}
...
func (o *ListMessageItem) GetAttachmentCount() int32 {
	if o == nil || IsNil(o.AttachmentCount.Get()) {
		var ret int32
		return ret
	}
...
func (o *ListMessageItem) GetRecipientCount() int32 {
	if o == nil || IsNil(o.RecipientCount.Get()) {
		var ret int32
		return ret
	}
...
func (o *ListMessageItem) GetCampaignClass() string {
	if o == nil || IsNil(o.CampaignClass.Get()) {
		var ret string
		return ret
	}
...
// SetCampaignClass gets a reference to the given NullableString and assigns it to the CampaignClass field.
