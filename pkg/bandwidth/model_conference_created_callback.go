...
// checks if the ConferenceCreatedCallback type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ConferenceCreatedCallback{}

// ConferenceCreatedCallback The Conference Created event is fired whenever a new conference that specified a callbackUrl is created. The response may be either empty or a BXML document. Only the following verbs are valid for conferences: PlayAudio, SpeakSentence, StartRecording, StopRecording, PauseRecording, ResumeRecording. Audio verbs will be heard by all members of the conference. Recordings capture audio from all members who are not muted or on hold, as well as any audio verbs that are played into the conference.
type ConferenceCreatedCallback struct {
...
func NewConferenceCreatedCallback() *ConferenceCreatedCallback {
	this := ConferenceCreatedCallback{}
	return &this
}
...
func (o *ConferenceCreatedCallback) SetTagNil() {
	o.Tag.Set(nil)
}
...
func (o ConferenceCreatedCallback) MarshalJSON() ([]byte, error) {
...
func (o ConferenceCreatedCallback) ToMap() (map[string]interface{}, error) {
...
type NullableConferenceCreatedCallback struct {
	value *ConferenceCreatedCallback
	isSet bool
}

func (v NullableConferenceCreatedCallback) Get() *ConferenceCreatedCallback {
	return v.value
}

func (v *NullableConferenceCreatedCallback) Set(val *ConferenceCreatedCallback) {
	v.value = val
	v.isSet = true
}

func (v NullableConferenceCreatedCallback) IsSet() bool {
	return v.isSet
}

func (v *NullableConferenceCreatedCallback) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableConferenceCreatedCallback(val *ConferenceCreatedCallback) *NullableConferenceCreatedCallback {
	return &NullableConferenceCreatedCallback{value: val, isSet: true}
}

func (v NullableConferenceCreatedCallback) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableConferenceCreatedCallback) UnmarshalJSON(src []byte) error {
	v.isSet = true
