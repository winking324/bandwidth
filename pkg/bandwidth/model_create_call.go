...
// checks if the CreateCall type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateCall{}
...
type CreateCall struct {
	...
	Uui NullableString `json:"uui,omitempty"`
...
// SetUui gets a reference to the given NullableString and assigns it to the Uui field.
...
func (o *CreateCall) GetAnswerMethod() CallbackMethodEnum {
	if o == nil || IsNil(o.AnswerMethod.Get()) {
...
func (o *CreateCall) GetDisconnectMethod() CallbackMethodEnum {
	if o == nil || IsNil(o.DisconnectMethod.Get()) {
		var ret CallbackMethodEnum
		return ret
	}
...
func (o *CreateCall) GetCallTimeout() float64 {
	if o == nil || IsNil(o.CallTimeout.Get()) {
		var ret float64
		return ret
	}
