...
// checks if the CallRecordingMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CallRecordingMetadata{}
...
func (o *CallRecordingMetadata) GetTranscription() RecordingTranscriptionMetadata {
	if o == nil || IsNil(o.Transcription.Get()) {
...
func (o *CallRecordingMetadata) GetRecordingName() string {
	if o == nil || IsNil(o.RecordingName) {
		var ret string
		return ret
	}
