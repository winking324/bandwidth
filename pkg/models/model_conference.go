...
type Conference struct {
	...
	CompletedTime utils.NullableTime `json:"completedTime,omitempty"`
	// The URL to send the conference-related events.
	ConferenceEventUrl utils.NullableString `json:"conferenceEventUrl,omitempty"`
...
func NewConference() *Conference {
	this := Conference{}
	var conferenceEventMethod CallbackMethodEnum = POST
...
func (o *Conference) GetCompletedTime() time.Time {
	if o == nil || utils.IsNil(o.CompletedTime.Get()) {
		var ret time.Time
		return ret
	}
...
// SetCompletedTime gets a reference to the given utils.NullableTime and assigns it to the CompletedTime field.
...
func (o *Conference) GetConferenceEventUrl() string {
	if o == nil || utils.IsNil(o.ConferenceEventUrl.Get()) {
		var ret string
		return ret
	}
...
// SetConferenceEventUrl gets a reference to the given utils.NullableString and assigns it to the ConferenceEventUrl field.
...
func (o *Conference) GetConferenceEventMethod() CallbackMethodEnum {
	if o == nil || utils.IsNil(o.ConferenceEventMethod.Get()) {
...
func (o *Conference) GetActiveMembersOk() ([]ConferenceMember, bool) {
	if o == nil || utils.IsNil(o.ActiveMembers) {
		return nil, false
	}
