...
type CallState struct {
	...
	ParentCallId utils.NullableString `json:"parentCallId,omitempty"`
	...
	Identity utils.NullableString `json:"identity,omitempty"`
	...
	StartTime utils.NullableTime `json:"startTime,omitempty"`
	...
	EndTime utils.NullableTime `json:"endTime,omitempty"`
	...
	DisconnectCause utils.NullableString `json:"disconnectCause,omitempty"`
...
func (o *CallState) GetParentCallId() string {
	if o == nil || utils.IsNil(o.ParentCallId.Get()) {
		var ret string
		return ret
	}
...
// SetParentCallId gets a reference to the given utils.NullableString and assigns it to the ParentCallId field.
...
func (o *CallState) GetStirShakenOk() (*map[string]string, bool) {
	if o == nil || utils.IsNil(o.StirShaken) {
		return nil, false
	}
...
func (o *CallState) GetIdentity() string {
	if o == nil || utils.IsNil(o.Identity.Get()) {
		var ret string
		return ret
	}
...
// SetIdentity gets a reference to the given utils.NullableString and assigns it to the Identity field.
...
func (o *CallState) GetStartTime() time.Time {
	if o == nil || utils.IsNil(o.StartTime.Get()) {
		var ret time.Time
		return ret
	}
...
// SetStartTime gets a reference to the given utils.NullableTime and assigns it to the StartTime field.
...
func (o *CallState) GetEndTime() time.Time {
	if o == nil || utils.IsNil(o.EndTime.Get()) {
		var ret time.Time
		return ret
	}
...
// SetEndTime gets a reference to the given utils.NullableTime and assigns it to the EndTime field.
...
func (o *CallState) GetDisconnectCause() string {
	if o == nil || utils.IsNil(o.DisconnectCause.Get()) {
		var ret string
		return ret
	}
...
// SetDisconnectCause gets a reference to the given utils.NullableString and assigns it to the DisconnectCause field.
...
func (o *CallState) GetLastUpdate() time.Time {
	if o == nil || utils.IsNil(o.LastUpdate) {
		var ret time.Time
		return ret
	}
	return *o.LastUpdate
