...
import (
	"encoding/json"
	"github.com/winking324/bandwidth-go-sdk/utils"
)
...
func (o *AccountStatistics) GetCurrentCallQueueSize() int32 {
	if o == nil || utils.IsNil(o.CurrentCallQueueSize) {
		var ret int32
		return ret
	}
...
func (o *AccountStatistics) GetMaxCallQueueSize() int32 {
	if o == nil || utils.IsNil(o.MaxCallQueueSize) {
		var ret int32
		return ret
	}
...
func (o AccountStatistics) ToMap() (map[string]interface{}, error) {
	...
	if !utils.IsNil(o.CurrentCallQueueSize) {
		toSerialize["currentCallQueueSize"] = o.CurrentCallQueueSize
	}
	if !utils.IsNil(o.MaxCallQueueSize) {
