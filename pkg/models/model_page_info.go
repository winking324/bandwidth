...
func (o *PageInfo) GetPrevPage() string {
	if o == nil || utils.IsNil(o.PrevPage) {
		var ret string
		return ret
	}
	return *o.PrevPage
...
func (o *PageInfo) GetNextPage() string {
	if o == nil || utils.IsNil(o.NextPage) {
		var ret string
		return ret
	}
	return *o.NextPage
...
func (o *PageInfo) GetPrevPageToken() string {
	if o == nil || utils.IsNil(o.PrevPageToken) {
		var ret string
		return ret
	}
...
func (o PageInfo) ToMap() (map[string]interface{}, error) {
	...
	if !utils.IsNil(o.PrevPage) {
		toSerialize["prevPage"] = o.PrevPage
	}
	if !utils.IsNil(o.NextPage) {
		toSerialize["nextPage"] = o.NextPage
	}
	if !utils.IsNil(o.PrevPageToken) {
