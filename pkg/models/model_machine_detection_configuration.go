...
type MachineDetectionConfiguration struct {
	...
	CallbackUrl utils.NullableString `json:"callbackUrl,omitempty"`
	...
	FallbackUrl utils.NullableString `json:"fallbackUrl,omitempty"`
...
func NewMachineDetectionConfiguration() *MachineDetectionConfiguration {
	...
	var callbackMethod CallbackMethodEnum = POST
	this.CallbackMethod = *NewNullableCallbackMethodEnum(&callbackMethod)
	var fallbackMethod CallbackMethodEnum = POST
...
func (o *MachineDetectionConfiguration) GetDetectionTimeout() float64 {
	if o == nil || utils.IsNil(o.DetectionTimeout.Get()) {
		var ret float64
		return ret
	}
...
func (o *MachineDetectionConfiguration) GetSilenceTimeout() float64 {
	if o == nil || utils.IsNil(o.SilenceTimeout.Get()) {
		var ret float64
		return ret
	}
...
func (o *MachineDetectionConfiguration) GetSpeechThreshold() float64 {
	if o == nil || utils.IsNil(o.SpeechThreshold.Get()) {
		var ret float64
		return ret
	}
...
func (o *MachineDetectionConfiguration) GetSpeechEndThreshold() float64 {
	if o == nil || utils.IsNil(o.SpeechEndThreshold.Get()) {
		var ret float64
		return ret
	}
...
func (o *MachineDetectionConfiguration) GetMachineSpeechEndThreshold() float64 {
	if o == nil || utils.IsNil(o.MachineSpeechEndThreshold.Get()) {
		var ret float64
		return ret
	}
...
func (o *MachineDetectionConfiguration) GetDelayResult() bool {
	if o == nil || utils.IsNil(o.DelayResult.Get()) {
		var ret bool
		return ret
	}
...
func (o *MachineDetectionConfiguration) GetCallbackUrl() string {
	if o == nil || utils.IsNil(o.CallbackUrl.Get()) {
		var ret string
		return ret
	}
...
// SetCallbackUrl gets a reference to the given utils.NullableString and assigns it to the CallbackUrl field.
...
func (o *MachineDetectionConfiguration) GetCallbackMethod() CallbackMethodEnum {
	if o == nil || utils.IsNil(o.CallbackMethod.Get()) {
...
func (o *MachineDetectionConfiguration) GetFallbackUrl() string {
	if o == nil || utils.IsNil(o.FallbackUrl.Get()) {
		var ret string
		return ret
	}
...
// SetFallbackUrl gets a reference to the given utils.NullableString and assigns it to the FallbackUrl field.
...
func (o *MachineDetectionConfiguration) GetFallbackMethod() CallbackMethodEnum {
	if o == nil || utils.IsNil(o.FallbackMethod.Get()) {
		var ret CallbackMethodEnum
		return ret
	}
